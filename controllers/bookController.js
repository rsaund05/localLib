...
exports.index = function(req, res) {   
    ...
    async.parallel({
        ...
        res.render('index', { title: 'localLib', error: err, data: results });
    });
};
    ...
    (req, res, next) => {
        ...
        if(!errors.isEmpty()) {
            async.parallel({
                ...
                res.render('book_form', {title: 'Create Book', authors: results.authors, genres: results.geres, book: book, errors: errors.array()});
            });
            return;
        } else {
